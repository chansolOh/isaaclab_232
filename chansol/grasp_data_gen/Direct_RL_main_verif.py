...
root_path = "/nas/Dataset/Dataset_2026/isaacsim_grasp_data_gen/test"
pre_grasp_path = "output_grasp"
output_grasp_path = "output_grasp_verif"
conf_path = "conf"
...
gripper_name = pre_grasp_data[0]["gripper_model"]
...
env = cs_robot.RobotEnv(cfg=env_cfg, pre_grasp_data=pre_grasp_data, conf_data=conf_data, debug=debug)
